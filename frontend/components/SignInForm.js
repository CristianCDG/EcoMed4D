...
exports.SignInFormDemo = SignInFormDemo;
var react_1 = require("react");
var label_1 = require("./ui/label");
var Input_1 = require("./ui/Input");
var cn_1 = require("../utils/cn");
var icons_react_1 = require("@tabler/icons-react");
function SignInFormDemo(_a) {
    var onSignUpClick = _a.onSignUpClick;
    ...
    return (<div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input_1.Input id="email" placeholder="cristian@hotmail.com" type="email"/>
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
        ...
        <LabelInputContainer className="mb-8">
          <label_1.Label htmlFor="password">Confirmar contraseña</label_1.Label>
          <Input_1.Input id="twitterpassword" placeholder="••••••••" type="password"/>
        </LabelInputContainer>

        <button className="bg-gradient-to-br relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset] mt-3" type="submit">
          Inicie sesión &rarr;
          <BottomGradient />
        </button>

        <button className="bg-gradient-to-br relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset] mt-3" type="button" onClick={onSignUpClick}>
           o Registrese &rarr;
          <BottomGradient />
        </button>
...
var LabelInputContainer = function (_a) {
    ...
    return (<div className={(0, cn_1.cn)("flex flex-col space-y-2 w-full", className)}>
      {children}
    </div>);
};
