...
export function SignupFormDemo({ onSignInClick }: SignupFormDemoProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Enviar los datos al servidor para registrar al usuario y enviar el correo de confirmación
      ...
      if (response.ok) {
        setGeneralMessage('Registro exitoso. Por favor revisa tu correo para confirmar.');
      } else {
